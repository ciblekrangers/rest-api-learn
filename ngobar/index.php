<?php
$curl = curl_init();
curl_setopt($curl, CURLOPT_URL, "https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCoIiiHof6BJ85PLuLkuxuhw&key=AIzaSyCa_1bUVj1oruFVsXA-ZWlSCpdOLjGpOzo");
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#home">Faisal Sidauruk</a>
  ...
  <div class="jumbotron" id="home">
    <div class="container">
      <div class="text-center">
        ...
        <h1 class="display-4">Faisal Sidauruk</h1>
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-md-5">
          <div class="row">
            <div class="col-md-4">
              <img src="<?= $youtubeProfile ?>" alt="" width="100" class="img-thumbnail rounded-circle" />
            </div>
            <div class="col-md-8">
              <h5><?= $chName ?></h5>
        ...
        <div class="col-md-5">
          <div class="row">
            <div class="col-md-4">
              <img src="img/profile1.png" alt="" width="100" class="img-thumbnail rounded-circle" />
            </div>
            <div class="col-md-8">
              <h5>@SandhikaGalih</h5>
              <p>860rb Followers</p>
